...
<style>
    ...
    .small {
        font: normal 13px sans-serif; background: white; text-align: left;
        line-height: 18px
    }
...
<!--     <div style="position:absolute; 
    ...
    <div style="position:absolute; 
        ...
        <path opacity="0.7" d="M0.502413 18.0491C0.529507 18.3239 0.774248 18.5247 1.04906 18.4976L5.52735 18.0561C5.80216 18.029 6.00297 17.7842 5.97587 17.5094C5.94878 17.2346 5.70404 17.0338 5.42923 17.0609L1.44853 17.4534L1.05606 13.4727C1.02897 13.1978 0.784229 12.997 0.509419 13.0241C0.234609 13.0512 0.0337959 13.296 0.0608899 13.5708L0.502413 18.0491ZM55.0303 1.00094C50.1199 0.702571 40.5631 -0.0529369 30.2268 1.72057C19.8877 3.49455 8.71665 7.80708 0.613463 17.6828L1.38654 18.3172C9.28335 8.69291 20.1941 4.4566 30.3959 2.70617C40.6004 0.955271 50.0436 1.69978 54.9697 1.99909L55.0303 1.00094Z" fill="black"/>
        </svg>
